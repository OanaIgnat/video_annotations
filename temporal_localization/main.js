...
let progress = 0;
const miniclipFileNameToUrl = miniclip_filename => '../data/temporal/miniclips/' + miniclip_filename;
// const channel_playlist = "8p12";
const channel_playlist = "1p0";
...
function main() {
    ...
    fetch('../data/temporal/miniclip_jsons/miniclip_actions_' + channel_playlist + '.json')
...
function saveDynamicDataToFile() {
    ...
    a.download = "../data/results_annotations/temporal/results" + channel_playlist + ".json";
    a.href = url;
